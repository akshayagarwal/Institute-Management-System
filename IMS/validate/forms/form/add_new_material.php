...
<title>Add New Material | Lead India Technologies</title>
...
<div class="content">
    <div id="signupbox">
       <div id="signuptab">
        <ul>
          <li id="signupcurrent"><a href=" ">Add New Material</a></li>
        </ul>
      </div>
      <div id="signupwrap">
      		<form  id="signupform" autocomplete="off" method="post" action="add_new_material_p.php">
	  		  <table>
	  		  <tr>
	  		  	<td class="label"><label for="material_name">Material Name</label></td>
	  		  	<td class="field"><input id="material_name" name="material_name" type="text"  maxlength="35"/></td>			
	  		  	<td class="status"></td>
	  		  </tr>
			  
	  		  <tr>
	  			<td class="label"><label for="quantity">Quantity</label></td>
	  			<td class="field"><input type="text" id="quantity" name="quantity" maxlength="9"/></td>
				<td class="status"></td>
			  </tr>
			  
			  <tr>
	  			<td class="label"><label for="remarks">Remarks</label></td>
	  			<td class="field"><input type="text" id="remarks" name="remarks" maxlength="50"/></td>
				<td class="status"></td>
			  </tr>
