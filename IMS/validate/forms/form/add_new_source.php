...
<h1>Add A New Enquiry Source</h1>
<div id="main">
...
<div class="content">
    <div id="signupbox">
       <div id="signuptab">
        <ul>
          <li id="signupcurrent"><a href=" ">Add New Enquiry Source</a></li>
        </ul>
      </div>
      <div id="signupwrap">
      		<form id="signupform" autocomplete="off" method="post" action="add_new_source_p.php">
	  		  <table>
	  		  
	  		  <tr>
	  			<td class="label"><label for="source_name">Source Name</label></td>
	  			<td class="field"><input type="text" id="source_name" name="source_name" value="" maxlength="20"/></td>
				<td class="status"></td>
	  		  </tr>
			  <tr>
