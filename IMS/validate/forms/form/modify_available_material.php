...
<title>Modify Available Material | Lead India Technologies</title>
...
<div class="content">
    <div id="signupbox">
       <div id="signuptab">
        <ul>
          <li id="signupcurrent"><a href=" ">Select Material</a></li>
        </ul>
      </div>
      <div id="signupwrap">
      		<form  id="signupform" autocomplete="off" method="post" action="modify_available_material_p.php">
	  		  <table>
	  		  <tr>
