...
<title>Print Welcome Kit | Lead India Technologies</title>
	...
	var validator = $("#signupform").validate({
		...
		messages: {
			...
			id: {
				      ...
				      maxlength: "Must be of 9 characters",
			},
			sbi: {
...
<div class="content">
    <div id="signupbox">
      ...
      <div id="signupwrap">
      		<form id="signupform" autocomplete="off" method="post" action="../../../print_student_personal_details.php" target='_blank'>
	  		  <table>
	  		  <tr>
