...
<title>View Enquiries| Lead India Technologies</title>
...
<link rel="stylesheet" type="text/css" media="screen" href="jcalendar.css" />

<script src="../../lib/jquery.js" type="text/javascript"></script>
<script src="../../jquery.validate.js" type="text/javascript"></script>
<script src="jcalendar.js" type="text/javascript"></script>
...
<div class="content">
    <div id="signupbox">
       <div id="signuptab">
        <ul>
          <li id="signupcurrent"><a href=" ">Select Start & End Date</a></li>
        </ul>
      </div>
      <div id="signupwrap">
	<div class="jcalendar-wrapper">
       <div class="jcalendar-selects">
      		...
      		<form id="signupform" autocomplete="off" method="post" action="../../../view_enquiries.php">
	  		  <table>

	  		  <tr>
	  			<td class="label"><label for="start">Start Date</label></td>
	  			<td class="field"><select name="dd1" id="day" class="jcalendar-select-day">
					<option>DD</option>
					<option>01</option>
					<option>02</option>
					<option>03</option>
				...
				<select name="mm1" id="month" class="jcalendar-select-month">
					<option>MM</option>
					<option>01</option>
					<option>02</option>
					<option>03</option>
				...
				<select name="yyyy1" id="year" class="jcalendar-select-year">
					<option>YYYY</option>
					<option>2010</option>
					<?php
					for($i=2011;$i<=2050;$i++)
			   ...
			   <tr>
	  			<td class="label"><label for="end">End Date</label></td>
	  			<td class="field"><select name="dd2" id="day" class="jcalendar-select-day">
					<option>DD</option>
					<option>01</option>
					<option>02</option>
					<option>03</option>
				...
				<select name="mm2" id="month" class="jcalendar-select-month">
					<option>MM</option>
					<option>01</option>
					<option>02</option>
					<option>03</option>
				...
				<select id="year" name="yyyy2" class="jcalendar-select-year">
					<option>YYYY</option>
					<option>2010</option>
					<?php
					for($i=2011;$i<=2050;$i++)
