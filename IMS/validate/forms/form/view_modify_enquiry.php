...
<title>View/Modify Enquiry Details | Lead India Technologies</title>
	...
	var validator = $("#signupform").validate({
		...
		messages: {
			...
			id: {
				      ...
				      minlength: "Must be of 11 characters",
				      maxlength: "Must br of 11 characters",
			},
			sbi: {
...
<div class="content">
    <div id="signupbox">
       <div id="signuptab">
        <ul>
          <li id="signupcurrent"><a href=" ">Enter Enquiry ID</a></li>
        </ul>
      </div>
      <div id="signupwrap">
      		<form id="signupform" autocomplete="off" method="post" action="view_modify_enquiry_p.php">
	  		  <table>
	  		  <tr>
	  		  	<td class="label"><label for="id">Enquiry ID</label></td>
	  		  	<td class="field"><input id="id" name="id" type="text" value="" maxlength="11"/></td>
				<td class="field"><input type="button" name="search_enquiry" value="Search" onClick="window.open('view_eq.php','view_eq.php')"/></td>
	  		  	<td class="status"></td>
	  		  </tr>
	  		  <tr>
