...
<div class="dtree">
	<?php
	include "dbinst.php";
		$query="SELECT ID,NAME,TIME FROM students WHERE ID='$studid'";
		$results=mysql_query($query);
		list($pid,$name2,$time)=mysql_fetch_row($results);
...
// ----------------- INTRODUCTION ------------------//
		...
		$query="SELECT PID,ID,NAME FROM students WHERE TIME>$time";
		$results=mysql_query($query);
